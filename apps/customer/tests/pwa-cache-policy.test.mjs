...
test("customer checks for a fresh service worker and reloads a stale controlled page", () => {
...
test("customer prevents browser caching of the app shell and service worker", () => {
